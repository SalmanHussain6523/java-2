...
// let var1 = 10, var2 = "Hello", var3 = true;
// (For Explanation 
// var1 is assigned the value 10 (a number).
// var2 is assigned the value "Hello" (a string).
// var3 is assigned the value true (a boolean).)


// question 2
// Declare 5 legal & 5 illegal variable names.
// Legal variable names
// myVariable              (camelCaseExample is best practice)
// _underscore             (we can use _ _underscore)
// $dollarsign             ( we can use $) dollar sign)
// userName123              (we can use alphabet then numbers)
// camelCaseExample         ( camelCaseExample better than all)

// illegal variable names

// my-myvariable             (we can,t use dash - in alphabet or numbers)
// break                      ( we can,t use break word or other word who can use in java script e.g., var, function, break, etc.)
// 123myvariable              (we can,t use numbers for innitial)
// user word                   ( we can,t use these types of words who give space on it)
// #hashtag                     ( dont use # hashtags)
...
// var rules_1 = "a variable cannot start with a numbers <br>"
// var rules_2 = "a variable cannot Words like let, const, var, break, function, etc., cannot be used as variable names. <br>"
// var rules_3 = "a variable can start with a letter, underscore, or dollar sign <br>"
// var rules_4 = "a Variables like myVar and MyVar are treated as distinct. <br>"
// var rules_5 = "a spaces are not allowed in variable names <br>"
// var rules_6 = "a Variable names are case-sensitive, so myVariable and myvariable are treated"

// document .write(heading)
// document .write(rules_1)
// document .write(rules_2)
// document .write(rules_3)
// document .write(rules_4)
// document .write(rules_5)
// document .write(rules_6)

//(b) 
// var rules_7 = "Variable names can only contain letter, number,undercsore_ and $ dollarsign.For example $my_1stVariable"

// document .write(rules_7)

//(c)
//  var rules_8 = "Variables must begin with a letter, underscore_ ordollarsign $. For example $name, _name or name"

// document .write(rules_8)

// (d)
// var rules_9 = "variable names are case myVariable , MyVariable"

// document .write(rules_9)

// (d)
// var rules_10 = "Variable names should not be JS var , function , break , if ,else ,  etc"

// document .write(rules_10)
